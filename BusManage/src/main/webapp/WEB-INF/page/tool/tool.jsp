            ...
            <div class="span12">
                <div class="widget-box">
                    <div class="widget-title"> <span class="icon"><i class="icon-th"></i></span>
                        ...
                        <form id="form" class="demo1" method="post" action="${pageContext.request.contextPath}/tool/getBusToolList">
                            ...
                            <ul>
                                ...
                                <li>
                                    ...
                                    <button onclick="showAdd()" type="button" class="btn btn-info" style="margin: 3px 5px 0 0;">新增工具</button>
                                </li>
                            </ul>
                        </form>
...
<script>
    ...
    function submit() {
        ...
        switch(parseInt(type)) {
            case 1://初始录入
                ...
                url = "${pageContext.request.contextPath}/tool/addTool";
                break;
            case 2://入库
                param = {
                    id:$("#editId").val(),
                ...
                url = "${pageContext.request.contextPath}/tool/ruKu";
                break;
            case 3://出库
                param = {
                    id:$("#editId").val(),
                ...
                url = "${pageContext.request.contextPath}/tool/chuKu";
                break;
        }
    ...
    function deletes(id) {
        if(confirm("您确定删除，删除后不可恢复")) {
            $.ajax({url:'${pageContext.request.contextPath}/tool/deleteBusTool',data:{id:id},success:function(result){
                    alert(result);
                    window.location.reload();
                },
                error:function () {
