            ...
            <div class="span12">
                <div class="widget-box">
                    <div class="widget-title"><span class="icon"><i class="icon-th"></i></span>
                        <h5>${!empty type ? "结算单信息数据":"费用结算查询"}</h5>
                        ...
                        <form id="form" class="demo1" method="post"
                            ...
                            <ul>
                                ...
                                <li>
                                    <div class="input-append date datepicker ">
                                        <h5>结算单号</h5>
                                        <input name="orderNo" placeholder="请输入结算单号" value="${orderNo}" type="text"
                                               class="span7">
                                    </div>
                                </li>
                                <li>
                        ...
                        <table class="table table-bordered ">
                            ...
                            <c:forEach items="${page.results}" varStatus="status" var="item">
                                ...
                                <tr class="gradeX">
                                    ...
                                    <td>${item.remark}</td>
                                    <td>${item.total}</td>
                                    <td>${item.status eq 1 ? "未结算" :'已结算'}</td>
...
<script>
    ...
    function jiesuan(id) {
        $.ajax({
            url: '${pageContext.request.contextPath}/finance/doJieSuan', data: {id: id}, success: function (result) {
                alert(result);
